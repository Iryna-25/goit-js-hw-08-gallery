...
const createdPreviewGallery = galleryItems.reduce((acc, img) => {
  let imgEl = `<li class="gallery__item"><a class="gallery__link"><img src="${img.preview}" alt="${img.description}" class="gallery__image" ></a></li>`
  return acc + imgEl
}, '');
